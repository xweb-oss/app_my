...
export default {
    ...
    methods:{
           mousedownFn:function (e) {  // 按下鼠标事件
                console.log(e)
                console.log(this.beginClientX,'鼠标初始按下的位置')
                if(!this.confirmSuccess){
                    
                    e.preventDefault && e.preventDefault();   //阻止文字选中等 浏览器默认事件
                    this.mouseMoveStata = true;    // 可以拖动
                    this.beginClientX = e.clientX;

                     console.log(this.beginClientX)
                }
            },       
            ...
            mouseMoveFn(e){  //mousemove事件 鼠标移动

                console.log(this.mouseMoveStata)   // 鼠标按下的时候，就允许拖动
